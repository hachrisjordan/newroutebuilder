        ...
        <div className="flex flex-col w-full md:flex-row md:items-center md:gap-6">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto mt-1 md:mt-0 md:ml-auto justify-end">
            <div className="flex w-full md:w-auto">
              <span className="inline md:hidden text-sm font-mono text-muted-foreground font-bold flex-1 text-left"></span>
            ...
            <span className="hidden md:inline text-sm font-mono text-muted-foreground font-bold"></span>
