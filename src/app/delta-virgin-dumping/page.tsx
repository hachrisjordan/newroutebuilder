      ...
      {(koreanAirFlights.length > 0 || koreanAirLoading) && (
        <div className="mt-12">
          ...
          {selectedFlight && selectedKoreanAirClass && (
            <div className="mt-8">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Combined Booking</h2>
                <p className="text-gray-600">Book your complete itinerary with Virgin Atlantic</p>
              </div>
              ...
              <Card className="rounded-xl border bg-card shadow">
                <CardContent className="p-6">
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3">
                      <h3 className="text-lg font-semibold text-gray-900">Selected Flights</h3>
                        ...
                        return (
                          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <div className="text-right">
                              <div className="font-medium">{selectedDeltaFlight.mileage_cost.toLocaleString()} miles</div>
                              <div className="text-sm text-gray-600">+ $1027.80</div>
                            </div>
                          </div>
                        );
                      })()}
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <div className="text-right">
                              <div className="font-medium">{miles.toLocaleString()} miles</div>
                              <div className="text-sm text-gray-600">+ ${(selectedKoreanFlight.TotalTaxes / 100).toFixed(2)}</div>
                            </div>
                          </div>
                        );
                      })()}
