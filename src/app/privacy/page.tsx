...
/**
 * Privacy Policy Page for bbairtools
 * Last updated: July 22, 2025
 * Contact: bin@bbairtools.com
 */

const PRIVACY_POLICY_LAST_UPDATED = 'July 22, 2025';

export default function PrivacyPolicyPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-gray-900 dark:text-gray-100">
      <h1 className="text-3xl font-bold mb-4">Privacy Policy for bbairtools</h1>
      <p className="mb-2 text-sm text-gray-500">Last updated: {PRIVACY_POLICY_LAST_UPDATED}</p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6 space-y-1">
          ...
          <li><b>Website</b> refers to bbairtools, accessible from <a href="https://www.bbairtools.com/" className="text-blue-600 underline">https://www.bbairtools.com/</a></li>
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Types of Data Collected</h3>
        ...
        <h4 className="text-lg font-semibold mt-2 mb-1">Usage Data</h4>
        <p>
      ...
      <section className="mb-8">
        <h3 className="text-xl font-semibold mt-4 mb-1">Tracking Technologies and Cookies</h3>
        <p>
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Business Transactions</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-4 mb-1">Other legal requirements</h3>
        <p>
