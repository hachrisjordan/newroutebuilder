...
/**
 * Terms and Conditions Page for bbairtools
 * Last updated: July 22, 2025
 * Contact: bin@bbairtools.com
 */

const TERMS_LAST_UPDATED = 'July 22, 2025';

export default function TermsPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-gray-900 dark:text-gray-100">
      <h1 className="text-3xl font-bold mb-4">Terms and Conditions</h1>
      <p className="mb-2 text-sm text-gray-500">Last updated: {TERMS_LAST_UPDATED}</p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6 space-y-1">
          ...
          <li><b>Terms and Conditions</b> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-terms-and-conditions-generator/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Free Terms and Conditions Generator</a>.</li>
          ...
          <li><b>Website</b> refers to bbairtools, accessible from <a href="https://www.bbairtools.com/" target="_blank" rel="external nofollow noopener" className="text-blue-600 underline">https://www.bbairtools.com/</a></li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2">For European Union (EU) Users</h2>
        <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.</p>
      </section>
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2">United States Legal Compliance</h2>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6">
          <li>By email: <a href="mailto:bin@bbairtools.com" className="text-blue-600 underline">bin@bbairtools.com</a></li>
        </ul>
      </section>
    </main>
  );
